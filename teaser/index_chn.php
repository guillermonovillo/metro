...
<head>
   ...
   <link rel="stylesheet" href="css/styles_phase_2.css" type="text/css" />
      ...
      <div class="floor-1 home">
         ...
         <div class="content">
            ...
            <footer class="footer">
               ...
               <p class="featured">独家营销<img class="img" src="img/logo_douglas_elliman.png" alt="Doouglas Elliman Development Marketing - Logo" width="126" height="22" /></p>
               <ul class="link-list">
         ...
         <section class="fullscreen">
            ...
            <div class="wrapper">
               <div class="disclaimer">
                  <div class="main-content">
                     <h1>免责申明</h1>
                     <p>本则广告非要约邀请。仅作为楼盘广告宣传使用。开发商尚不得进行任何具有约束力的合同约定。开发商未授权任何房产经纪人或代理人代表本楼盘或发表相关声明，任何与房产经纪人达成的协议、已付押金或其他安排均对开发商无约束力。此广告材料非楼盘出售要约亦非对任何州或未经登记辖区的居民的要约邀请。</p>
                  </div>
               </div>
            </div>
         </section>
